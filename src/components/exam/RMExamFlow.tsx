...
export function RMExamFlow({
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      {" "}
      {/* Added bottom padding for fixed navigator */}
      {/* Header */}
          ...
          <div className="p-6">
            ...
            <div className="mt-6 p-3 bg-gray-50 rounded-lg">
              <p className="text-xs text-gray-600">
                <strong>Keyboard shortcuts:</strong> A-D (select answer), N
                (next), P (previous), F (flag)
              </p>
            </div>
          </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-10 md:grid-cols-15 lg:grid-cols-20 gap-1 max-h-32 overflow-y-auto">
                {rmQuestions.map((_, index: number) => {
                  const isAnswered =
                    answers[rmQuestions[index].id] !== undefined;
          ...
          <div className="bg-white rounded-lg max-w-md w-full">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                ...
                lost and you cannot resume this attempt.
              </p>
