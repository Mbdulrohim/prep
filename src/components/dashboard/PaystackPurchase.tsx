...
export function PaystackPurchase() {
  ...
  return (
    <div className="space-y-6">
      {/* Single Plan Display */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Exam Access Plan</h3>
          ...
          <div className="relative bg-white border-2 border-blue-500 rounded-2xl p-6 shadow-lg">
            ...
            <div className="text-center mb-4">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <h3 className="text-xl font-bold text-gray-900">{examPlan.name}</h3>
              </div>
            ...
            <div className="text-center mb-6">
              <div className="flex items-center justify-center gap-2">
                <span className="text-3xl font-bold text-gray-900">₦{examPlan.price.toLocaleString()}</span>
              </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-blue-700 text-sm mt-1">
              Your payment is processed securely through Paystack. You'll get instant access after successful payment.
            </p>
          </div>
        </div>
      </div>
