...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'PREP - Nigerian Nursing Exam Preparation Platform',
    description: 'Master your nursing exams with 10,000+ practice questions, AI-powered help, and comprehensive study tools designed for Nigerian nursing students.',
    url: '/',
    siteName: 'PREP',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'PREP - Nigerian Nursing Exam Preparation Platform',
    description: 'Master your nursing exams with 10,000+ practice questions and AI-powered study tools.',
    images: ['/image.png'],
  },
  robots: {
    index: true,
