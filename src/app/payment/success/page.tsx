        ...
        {status === "success" ? (
          <>
            ...
            <div className="space-y-3">
              {/* WhatsApp group invitation for all successful payments */}
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                <h3 className="text-lg font-semibold text-green-900 mb-2">
                  🎉 Join Our Study Community!
                </h3>
                <p className="text-green-700 text-sm mb-3">
                  Connect with fellow students, get exam tips, and stay updated with the latest information in our WhatsApp group.
                </p>
                <a
                  href="https://chat.whatsapp.com/BRzLmPSb1a07fPLLZbf6Ws?mode=ac_t"
                  target="_blank"
